          ...
          <button type='button' className='menu_button'>
            <div className='menu_option'>
              <svg width='30' height='30' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path d='M.69.25h29.14v29.428H.69z' />
                <path d='M.69.25h29.14v29.428H.69z' />
                <path d='M11.452 9.25H23.83M11.452 14.964H23.83M11.452 20.678H23.83M6.69 9.25h.01M6.69 14.964H6.7M6.69 20.678H6.7' stroke='#C7C7C7' />
              </svg>
              <p>Transacciones</p>
            </div>
          </button>
