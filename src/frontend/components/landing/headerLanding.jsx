    ...
    return (
            <header className="p">
                <div className="header--title-container">
                   <div className="header--title-batata">
                   <svg width="70" height="70" viewBox="0 0 41 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="header--description">Batatabit ayuda a navegar entre los diferentes precios y tendencias</p>
                    <a className="header--button" href="#plans">Conoce nuestros planes <span><img src={arrow} alt=""/></span></a>
                </div>
            </header>
    )
}
